...
% Lenghts (check these with measured values and then remove this comment)
...
% Radius of Curvature [1/m] from 
% http://www.ligo.caltech.edu/~gari/COCAsBuilt.htm
par.IX.ROC = 13.91e3;%14760;
par.IY.ROC = 13.6e3;%14520;
par.EX.ROC = 7.26e3;%8730;
par.EY.ROC = 7.32e3;%8720;
par.BS.ROC = 336e3;%5e5;
par.PR.ROC = 14.4e3;%14760;
