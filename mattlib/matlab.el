...
;; Keywords: MATLAB
;;
;; Modified 2003-Jan-18
;; Shourov K. Chatterji
;; shourov@ligo.mit.edu
;;
;; Copyright (C) 1997-2002 Eric M. Ludlam
...
(defcustom matlab-keyword-list '(
  "if" "else" "elseif" "for" "while" "break" "continue"
  "switch" "case" "otherwise" "try" "catch" "return"
  "eval" "evalc" "feval" "function" "global" "error" "warning"
  "endfunction" "run" "help"
)
...
;; added most of the more commonly used basic matlab functions
;; Shourov Chatterji 2003-Jan-18
(defcustom matlab-builtin-functions-list '(
  "plot" "loglog" "semilogx" "semilogy" "polar" "plotyy"
  "figure" "clf" "axis" "axes" "subplot" "zoom" "grid" "hold" "box"
  "plotedit" "legend" "title" "xlabel" "ylabel" "zlabel" "title"
  "textlabel" "text" "gtext" "line" "patch"
  "orient" "print" "printopt" "get" "set"
  "surf" "mesh" "contour" "polar" "bar" "errorbar" "scatter" "stem" "hist" "zplane"
  "clear" "load" "save" "fprintf" "fscanf" "input" "fgets" "fgetl"
  "sprintf" "sscanf" "fopen" "fclose" "fread" "fwrite"
  "feof" "ferror" "frewind" "fseek" "ftell" "pause" "disp"
  "num2str" "strcat" "strcmp"
  "zeros" "ones" "eye" "rand" "randn" "linspace" "logspace" "meshgrid"
  "size" "length" "diag" "find" "fliplr" "flipud" "end"
  "norm" "rank" "det" "trace" "eig" "svd"
  "sin" "sinh" "asin" "asinh" "cos" "cosh" "acos" "acosh" "tan" "tanh" "atan" "atan2" "atanh"
  "sec" "sech" "asec" "asech" "csc" "csch" "acsc" "acsch" "cot" "coth" "acot" "acoth" "sinc"
  "exp" "log" "log10" "log2" "sqrt"
  "abs" "angle" "conj" "imag" "real" "unwrap"
  "max" "min" "mean" "median" "std" "var" "sum" "prod"
  "fix" "floor" "ceil" "round" "mod" "rem" "sign"  "cumsum" "cumprod" "diff"
  "quad" "dblquad" "ode45" "fminsearch"
  "roots" "poly" "polyval" "conv" "deconv"
  "freqs" "freqz" "grpdelay" "impz"
  "filter" "filtfilt" "fft" "ifft"
  "sys" "tf" "zpk" "zpkdata" "tfdata"
  "besself" "butter" "buttord" "cheby1" "cheb1ord" "cheby2" "cheb2ord" "ellip" "ellipord"
  "remez" "yulewalk" "levinson" "lpc"
  "csd" "psd" "corrcoef" "cohere" "cov" "xcorr" "xcov" "pwelch" "specgram" "detrend"
)

  "List of major builtin functions used in highlighting.
Customizing this variable is only useful if `regexp-opt' is available."
  :group 'matlab
...
\\|for\\|global\\|if\\|otherwise\\|return\\|switch\\|try\\|while\\)\\>")
   ...
   (list
    (if (fboundp 'regexp-opt)
	(concat "\\<\\(" (regexp-opt matlab-builtin-functions-list) "\\)\\>")
...
\\(\\([^\n,;%(]+\\|([^\n%)]+)\\)+\\)"
    ...
    '("\\<\\(eps\\|pi\\|inf\\|Inf\\|NaN\\|nan\\|ans\\|nargin\\|nargout\\|i\\|j\\|^>>\\)\\>"
      1 font-lock-variable-name-face)
    '("\\<[0-9]\\.?\\(i\\|j\\)\\>" 1 font-lock-variable-name-face)
...
(defvar matlab-keywords-return
  '("acos" "acosh" "acot" "acoth" "acsch" "asech" "asin" "asinh"
    ...
    "abs" "sign" "sqrt" "max" "min" "floor" "ceil" "abs")
...
(defun matlab-highlight-block-match (buff-when-launched)
...
BUFF-WHEN-LAUNCHED is the buffer that was active when the timer was set."
  ...
  ;; initialized from.
  (when (eq buff-when-launched (current-buffer))
